...
@Component({
  selector: 'app-table-list-catechesis',
  templateUrl: './table-list-catechesis.component.html',
  styleUrls: ['./table-list-catechesis.component.css']
})
export class TableListCatechesisComponent {
   // ~~~~~~~~~~~ Search variables ~~~~~~~~~~ //
