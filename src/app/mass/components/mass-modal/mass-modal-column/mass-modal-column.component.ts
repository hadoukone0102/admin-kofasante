...
@Component({
  selector: 'app-mass-modal-column',
  templateUrl: './mass-modal-column.component.html',
  styleUrls: ['./mass-modal-column.component.css']
})
export class MassModalColumnComponent {
