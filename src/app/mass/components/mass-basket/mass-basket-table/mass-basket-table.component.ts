...
@Component({
  selector: 'app-mass-basket-table',
  templateUrl: './mass-basket-table.component.html',
  styleUrls: ['./mass-basket-table.component.css']
})
export class MassBasketTableComponent {
  //~~~~~~~~~~~~~~~Modal~~~~~~~~~~~~~~~~
  Basket!:Basket;
   // ~~~~~~~~~~~~~~~~~~~~ Paginator~~~~~~~~~~~~~~~~~~~~~~~~
   isFirstPage!: string;
